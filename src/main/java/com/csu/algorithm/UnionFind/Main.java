...
//
//
//import com.csu.algorithm.UnionFind.union.GenericUnionFind;
...
////		testTime(new com.mj.union.UnionFind_QU_R_PC(count));
////		testTime(new com.mj.union.UnionFind_QU_R_PS(count));
////		testTime(new com.mj.union.UnionFind_QU_R_PH(count));
...
//	}
//
//	static void testTime(UnionFind_QU_R_PC uf) {
...
//		uf.union(9, 11);
//
//		com.mj.tools.Asserts.test(!uf.isSame(2, 7));
//
//		uf.union(4, 6);
//
//		com.mj.tools.Asserts.test(uf.isSame(2, 7));
//
//		com.mj.tools.Times.test(uf.getClass().getSimpleName(), () -> {
//			for (int i = 0; i < count; i++) {
...
//	}
//
//	static void testTime(UnionFind_QU_R_PS uf) {
//		uf.union(0, 1);
//		uf.union(0, 3);
//		uf.union(0, 4);
//		uf.union(2, 3);
